...
public class BaseTriangularFunction : BaseMembershipFunction
{
    private readonly bool _isSymmetric;

    protected BaseTriangularFunction(string name, double a, double b, double c, double uMax = 1) : base(name, uMax)
    {
        CheckEdges(a, b, c);
        CheckSides(a, b, c);
        A = a;
