...
public class BaseRightTrapezoidalFunction : BaseMembershipFunction
{
    protected BaseRightTrapezoidalFunction(string name, double a, double b, double uMax = 1) : base(name, uMax)
    {
        CheckValues(a, b);
        A = a;
        B = b;
