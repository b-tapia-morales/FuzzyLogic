...
public class SigmoidFunction : MembershipFunction, IAsymptoteFunction<double>
{
    ...
    protected SigmoidFunction(string name, double a, double c, double uMax = 1) : base(name, uMax)
    {
        CheckAValue(A);
        A = a;
        C = Inflection = c;
